...
const assesement = require("../src/task15");
...
function createBST(arr){
    ...
    return {
        root: mytree.root,
        reverseLevelOrderTraversalFromBottom: mytree.reverseLevelOrderTraversalFromBottom()
    };
}
function checkResult(arr){
        let bst = createBST(arr);
        let reverseLevelOrderTraversalFromBottom = assesement(bst.root);
        // assesedInorderTraversal =[];
        // inorder(root);
        //console.log(reverseLevelOrderTraversal);
       // console.log(reverseLevelOrderTraversalFromBottom);
        assert.deepEqual(bst.reverseLevelOrderTraversalFromBottom,reverseLevelOrderTraversalFromBottom);
}
